...
public class CalculadoraTelaVM
{
    ...
    public decimal UrdimbreTejido { get; set; } = 0m;

    [Display(Name = "Cinta Urdimbre")]
    public decimal CintaUrdimbre { get; set; } = 0m;

    [Display(Name = "Urdimbre Denier")]
    public decimal UrdimbreDenier { get; set; } = 0m;

    // --- TRAMA BASE ---
    [Display(Name = "Trama Tejido")]
    public decimal TramaTejido { get; set; } = 0m;

    [Display(Name = "Cinta Trama")]
    public decimal CintaTrama { get; set; } = 0m;

    [Display(Name = "Trama Denier")]
    public decimal TramaDenier { get; set; } = 0m;
    ...
    // Peso individual del hilo de Refuerzo (Excel Hoja2, celda E12 = (B5*D5)/228.6).
    // Se muestra junto a Urdimbre/Trama en el bloque RESULTADOS, en el mismo
    // orden que la hoja (fila 12: Conos | Refuerzo | Resistencia | Peso | %).
    public decimal PesoRefuerzo { get; set; }
