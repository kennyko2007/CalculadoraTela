...
builder.Services.Configure<EmailSettings>(options =>
{
    ...
    var envUser = Environment.GetEnvironmentVariable("GMAIL_USER");
    var envPass = Environment.GetEnvironmentVariable("GMAIL_APP_PASSWORD");

    if (!string.IsNullOrEmpty(envUser)) options.SmtpUser = envUser;
    if (!string.IsNullOrEmpty(envPass)) options.SmtpPass = envPass;
});
