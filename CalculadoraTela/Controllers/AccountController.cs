...
public class AccountController : Controller
{
    ...
    public async Task<IActionResult> Register(RegisterViewModel model)
    {
        ...
        var nuevoUsuario = new ApplicationUser
        {
            ...
            // La verificación por correo está desactivada: la cuenta queda
            // lista para usarse de inmediato.
            EmailConfirmed = true
        };
        ...
        _logger.LogInformation("Nuevo usuario registrado: {Usuario}.", nuevoUsuario.UserName);

        // Inicia sesión automáticamente, sin pasar por confirmación de correo.
